/* 
 * RV: This is a slightly modified version of the GNU test function: test-sigaction.c
 * Changes to gnu source:
 * 1. Diffed out the signature check
 * 2. Diffed out some asserts - I don't know what the problem is
 */
...
#if 0  /* RV:CRM: I know not why we need SIGNATURE_CHECK - we are not verifying the compiler */
#include "signature.h"
