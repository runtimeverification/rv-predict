...
static const uint16_t end_u16 = 0x1122;
static const uint32_t end_u32 = 0x11223344;
static const uint64_t end_u64 = 0x1122334455667788;
...
main(void)
{
	...
	assert(atomic_fetch_or(&u8, initial_u8   >> 4) == initial_u8);
