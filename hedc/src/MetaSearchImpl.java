...
* All rights reserved
*
* @version $Id: MetaSearchImpl.java,v 1.1 2010/06/30 15:07:00 smhuang Exp $
...
public class MetaSearchImpl implements MetaSearch {
    ...
    private MetaSearchImpl() {
        ...
        MSR_ROW_HEADER_TEMPLATE_ = FormFiller.internalize("hedc_synoptic_row_header.html");
        MSR_ROW_LINE_TEMPLATE_ = FormFiller.internalize("hedc_synoptic_row_body.html");
        MSR_ROW_EMPTY_LINE_TEMPLATE_ = FormFiller.internalize("hedc_synoptic_row_empty_body.html");
