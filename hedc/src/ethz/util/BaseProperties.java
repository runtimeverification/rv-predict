 ...
 * All rights reserved
 * 
 * $Id: BaseProperties.java,v 1.1 2010/06/30 15:07:04 smhuang Exp $
 * 
 * 28/03/99  cvp 
 *
 */
...
public class BaseProperties extends Properties {
    ...
    private final static String BPR_ID_ = "$Id: BaseProperties.java,v 1.1 2010/06/30 15:07:04 smhuang Exp $";
