 ...
 * All rights reserved
 * 
 * $Id: ObservableProperties.java,v 1.1 2010/06/30 15:07:05 smhuang Exp $
 * 
 * 28/03/99  cvp 
 *
 */
...
public class ObservableProperties extends BaseProperties {
    ...
    private final static String OPR_ID_ = "$Id: ObservableProperties.java,v 1.1 2010/06/30 15:07:05 smhuang Exp $";
