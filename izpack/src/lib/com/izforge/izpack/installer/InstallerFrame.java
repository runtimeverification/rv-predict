...
public class InstallerFrame extends JFrame
{
     ...
     */
    public ArrayList<Integer> visiblePanelMapping;

    /**
     * Registered GUICreationListener.
     */
    public ArrayList<GUIListener> guiListener;

    /**
     * Heading major text.
     */
    public JLabel[] headingLabels;
     ...
     */
    public JComponent headingCounterComponent;
     ...
     * @throws Exception
     */
    public void loadCustomIcons() throws Exception
    {
     ...
     */
    public void switchPanel(int last)
    {
    ...
    private class BlockFocusTraversalPolicy extends java.awt.DefaultFocusTraversalPolicy
    {
         ...
         */
        public boolean accept(Component aComp)
        {
