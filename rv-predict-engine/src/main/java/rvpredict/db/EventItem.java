...
public class EventItem {
     ...
     * @param tid thread identifier primary key (see {@link rvpredict.trace.TraceMetadata#threadIdNamemap})
     * @param id object identifier
     * @param addrl statement location identifier (see {@link rvpredict.trace.TraceMetadata#stmtIdSigMap})
