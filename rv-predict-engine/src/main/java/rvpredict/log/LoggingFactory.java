...
public interface LoggingFactory {
    /**
     * Creates an {@link rvpredict.log.EventPipe} used for communicating events from
     ...
     * @return a new {@link rvpredict.log.EventOutputStream}
     ...
     * @return the next available {@link rvpredict.log.EventInputStream} or {@code null}
