...
public class CompactEventReader {
    ...
    enum Type {
        ...
        LOAD1(2, new DataManipulationReader(1, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.NOT_ATOMIC)),
        LOAD2(3, new DataManipulationReader(2, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.NOT_ATOMIC)),
        LOAD4(4, new DataManipulationReader(4, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.NOT_ATOMIC)),
        LOAD8(5, new DataManipulationReader(8, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.NOT_ATOMIC)),
        LOAD16(6, new DataManipulationReader(16, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.NOT_ATOMIC)),

        // store: 1, 2, 4, 8, 16 bytes wide.
        STORE1(7, new DataManipulationReader(1, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.NOT_ATOMIC)),
        STORE2(8, new DataManipulationReader(2, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.NOT_ATOMIC)),
        STORE4(9, new DataManipulationReader(4, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.NOT_ATOMIC)),
        STORE8(10, new DataManipulationReader(8, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.NOT_ATOMIC)),
        STORE16(11, new DataManipulationReader(16, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.NOT_ATOMIC)),

        // atomic load: 1, 2, 4, 8, 16 bytes wide.
        ATOMIC_LOAD1(24, new DataManipulationReader(1, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.ATOMIC)),
        ATOMIC_LOAD2(25, new DataManipulationReader(2, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.ATOMIC)),
        ATOMIC_LOAD4(26, new DataManipulationReader(4, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.ATOMIC)),
        ATOMIC_LOAD8(27, new DataManipulationReader(8, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.ATOMIC)),
        ATOMIC_LOAD16(28, new DataManipulationReader(16, CompactEvent.DataManipulationType.LOAD, CompactEvent.Atomicity.ATOMIC)),

        // atomic store: 1, 2, 4, 8, 16 bytes wide.
        ATOMIC_STORE1(29, new DataManipulationReader(1, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.ATOMIC)),
        ATOMIC_STORE2(30, new DataManipulationReader(2, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.ATOMIC)),
        ATOMIC_STORE4(31, new DataManipulationReader(4, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.ATOMIC)),
        ATOMIC_STORE8(32, new DataManipulationReader(8, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.ATOMIC)),
        ATOMIC_STORE16(33, new DataManipulationReader(16, CompactEvent.DataManipulationType.STORE, CompactEvent.Atomicity.ATOMIC)),
        ...
        THREAD_FORK(12, new ThreadSyncReader(CompactEvent.ThreadSyncType.FORK)),  // create a new thread
        THREAD_JOIN(13, new ThreadSyncReader(CompactEvent.ThreadSyncType.JOIN)),  // join an existing thread
        ...
        THREAD_SWITCH(18, new ThreadSyncReader(CompactEvent.ThreadSyncType.SWITCH)),  // switch thread context

        LOCK_ACQUIRE(14, new LockManipulationReader(CompactEvent.LockManipulationType.LOCK)),  // acquire lock
        LOCK_RELEASE(15, new LockManipulationReader(CompactEvent.LockManipulationType.UNLOCK)),  // release lock
    ...
    public List<CompactEvent> dataManipulation(
            ...
            long address,
            long value,
            CompactEvent.Atomicity atomicity) throws InvalidTraceDataException {
    ...
    public List<CompactEvent> begin(Context context, long threadId, long generation)
            throws InvalidTraceDataException {
    ...
    public List<CompactEvent> threadSync(
            Context context, CompactEvent.ThreadSyncType threadSyncType, long threadId) throws InvalidTraceDataException {
        CompactEvent.CompactType compactType;
