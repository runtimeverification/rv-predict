...
public class SignalInterruptLocationsRestrictSourceTest {
    ...
    public void alwaysTrueWithoutEvents() {
        ...
        RestrictSource restrictSource = new SignalInterruptLocationsRestrictSource(
                eventsByThreadId,
    ...
    public void signalCanInterruptAtThreadWithoutEnableWhenAllowed() {
        ...
        restrict = restrictSource.createRestrict();
        Assert.assertFalse(restrict.evaluate(ModelRestrictUtils.mockVariableSource(
                "citv102", Integer.toString(TTID_1))));
    }
