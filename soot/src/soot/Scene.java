    	...
    	if(log!=null && log.length()>0) {
			...
			try {
				...
				while((line=reader.readLine())!=null) {
					...
					else if(kind.equals("Field.getDeclaringClass") 
							|| kind.equals("Field.getModifiers")
							|| kind.equals("Field.getName")
							|| kind.equals("Method.getName")
							|| kind.equals("Method.getDeclaringClass")
							|| kind.equals("Method.getModifiers")
							|| kind.equals("Class.getDeclaredMethod")
							|| kind.equals("Class.getDeclaredMethods")
							|| kind.equals("Class.getMethod")
							|| kind.equals("Constructor.getModifiers")
							|| kind.equals("Class.getDeclaredField")) {
						classNames.add(signatureToClass(target));
					}
